    ...
    return (
        <div className='header-container'>
            <div className="header d-flex align-items-center">
                <div className="logo">
                    <a className="logo-a" href="/"><FaBuilding size={30} /></a>
                </div>
                <select
                    value={loc}
                    onChange={(e) => {
                ...
                <div className="user-menu-icon" onClick={() => setIsUserMenuOpen(!isUserMenuOpen)}>
                    <FaUserCircle size={30} />
                </div>
            </div>

            {/* User Dropdown Menu */}
            <div className={`user-menu ${isUserMenuOpen ? "menu-open" : ""}`}>
                {!!localStorage.getItem('token') && (
                    <>
                        <Link to="/add-product" className="menu-item">Add Product</Link>
                        <Link to="/liked-products" className="menu-item">Favourites</Link>
                        <Link to="/my-products" className="menu-item">My Ads</Link>
                    </>
                )}
                <div>
                    {!localStorage.getItem('token') ? (
